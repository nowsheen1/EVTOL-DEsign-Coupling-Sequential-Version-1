...
[xopt,fvalopt, FLAG, OUTPUT] = surrogateopt(func,x0,A,b,Aeq,beq,lb,ub,constraints,options);
...
%Objective
    ...
    function [fATC,ceqn]=myfun(x,xU,xL, vU,vL,wU,wL,misc) %changed this line
